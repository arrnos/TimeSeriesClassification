...
file = pd.read_excel("MovementAAL/bcu_data/bcu_mysql_table/Z1_detail.xlsx")
...
file.to_sql(name = 'lineData',con = engine,if_exists = 'append',index = False,index_label = False)
